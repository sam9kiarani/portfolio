    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <span onClick={() => scrollToSection('home')}>Sam Kiarani</span>
          </motion.div>


          <a href="https://wa.me/254794831987?text=" target="_blank" className='flex gap-2 text-gray-700 dark:text-gray-300 hover:scale-105 dark:hover:scale-105 font-medium'>
            ...
            <h5 className='font-medium'>+254 794 831 987</h5>
          </a>
